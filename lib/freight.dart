...
class Freight {
  ...
  static Future<Map<String, dynamic>> init(String appId, String appSecurity, String eeCode, String env) async {
    final Map<dynamic, dynamic> result =
        await (_channel.invokeMethod("init", {"appId": appId, "appSecurity": appSecurity, "eeCode": eeCode, "env": env}) as FutureOr<Map<dynamic, dynamic>>);
  ...
  static Future<Map<String, dynamic>> start(List<Map<String, dynamic>> ships) async {
    final Map<dynamic, dynamic> result = await (_channel.invokeMethod("start", {"ships": ships}) as FutureOr<Map<dynamic, dynamic>>);
  ...
  static Future<Map<String, dynamic>> stop(List<Map<String, dynamic>> ships) async {
    final Map<dynamic, dynamic> result = await (_channel.invokeMethod("stop", {"ships": ships}) as FutureOr<Map<dynamic, dynamic>>);
  ...
  static Future<Map<String, dynamic>> getLocation() async {
    Map<dynamic, dynamic> result = await (_channel.invokeMethod("getLocation") as FutureOr<Map<dynamic, dynamic>>);
